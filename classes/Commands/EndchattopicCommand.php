 ...
 */
class EndchattopicCommand extends UserCommand
{
    /**
     * @var string
     */
    protected $name = 'endchattopic';

    /**
     * @var string
     */
    protected $description = 'End active chat and delete topic. New topic will be created next time.';

    /**
     * @var string
     */
    protected $usage = 'Type /endchattopic';
